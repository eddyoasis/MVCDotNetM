...
namespace MVCWebApp.Services
{
    ...
    {
        Task<string> AuthenticateAndGetUserByPass(string username, string password);
    ...
    {
        public async Task<string> AuthenticateAndGetUserByPass(string username, string password)
        {
