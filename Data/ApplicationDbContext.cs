    ...
    public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : DbContext(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MarginCallMTM>()
                ...
                .Ignore(u => u.MTMTriggerFlag)
                .Ignore(u => u.MarginCallFlag)
                .Ignore(u => u.MarginCallTriggerFlag)
                .Ignore(u => u.StoplossTriggerFlag)
                .Ignore(u => u.MOCTriggerFlag)
                .Ignore(u => u.ModifiedDatetime)
                .Ignore(u => u.MarginCallTriggerDatetime)
                .Ignore(u => u.StoplossTriggerDatetime)
                .Ignore(u => u.MOCTriggerDatetime)
                .Ignore(u => u.EmailTo)
                .Ignore(u => u.Remarks)
                .Ignore(u => u.Type);
